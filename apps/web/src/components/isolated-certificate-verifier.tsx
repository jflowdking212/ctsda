...
export function IsolatedCertificateVerifier({
  ...
  return (
    <main style={{ backgroundColor: '#ffffff', minHeight: '100vh', paddingBottom: '6rem', width: '100%' }}>
      ...
      {/* Content Area */}
      <div style={{ maxWidth: '1000px', margin: '-7rem auto 0', padding: '0 1.5rem', position: 'relative', zIndex: 20 }}>
        ...
        {!hasResult ? (
          ...
          <>
            ...
            >
              <div style={{
                width: '64px', height: '64px', backgroundColor: '#334b6b', color: 'white',
              ...
              <form onSubmit={handleSubmit} style={{ textAlign: 'left' }}>
                <div style={{ marginBottom: '1.5rem' }}>
                  <label
                    ...
                    style={{ display: 'block', fontSize: '0.85rem', fontWeight: 600, color: '#0f172a', marginBottom: '0.5rem' }}
                  >
                    Certificate Number
                  </label>
                  <input
                    ...
                    style={{
                      ...
                      backgroundColor: '#ffffff', color: '#0f172a', textTransform: 'uppercase',
                      outline: 'none',
                    }}
                  />
                </div>
                ...
                <button
                  ...
                  disabled={loading}
                  style={{
                    width: '100%', backgroundColor: '#021a42', color: '#ffffff',
                    fontWeight: 600, fontSize: '0.95rem', padding: '0.875rem 1.5rem',
                    borderRadius: '0.5rem', border: 'none',
                    cursor: loading ? 'not-allowed' : 'pointer',
                    display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem',
                    transition: 'background-color 0.2s',
                  }}
                  onMouseOver={(e) => (e.currentTarget.style.backgroundColor = '#010d21')}
                  onMouseOut={(e) => (e.currentTarget.style.backgroundColor = '#021a42')}
                >
              ...
              {result && !result.valid && (
                <div style={{ marginTop: '1rem', color: '#b91c1c', fontSize: '0.875rem', padding: '1rem', backgroundColor: '#fef2f2', borderRadius: '0.5rem' }}>
                  {result.message}
                </div>
              )}

              <div style={{ marginTop: '1.5rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem', color: '#94a3b8', fontSize: '0.8rem' }}>
            ...
            <div style={{ textAlign: 'center', marginBottom: '4rem', maxWidth: '800px', margin: '0 auto' }}>
              <h2 style={{ fontSize: '1.1rem', fontWeight: 700, color: '#0f172a', marginBottom: '2.5rem' }}>How It Works</h2>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1.5rem' }}>
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flex: 1 }}>
                  <div style={{ width: '48px', height: '48px', borderRadius: '50%', backgroundColor: '#ffffff', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1rem', color: '#334b6b', border: '1px solid #e2e8f0', boxShadow: '0 2px 5px rgba(0,0,0,0.05)' }}>
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
                  </div>
                  <h3 style={{ fontSize: '0.95rem', fontWeight: 600, color: '#0f172a', marginBottom: '0.5rem' }}>Step 1</h3>
                  <p style={{ fontSize: '0.85rem', color: '#64748b', maxWidth: '200px' }}>Enter your certificate number in the field above.</p>
                </div>
                
                <div style={{ color: '#cbd5e1', alignSelf: 'flex-start', marginTop: '1.5rem' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flex: 1 }}>
                  ...
                  <h3 style={{ fontSize: '0.95rem', fontWeight: 600, color: '#0f172a', marginBottom: '0.5rem' }}>Step 2</h3>
                  <p style={{ fontSize: '0.85rem', color: '#64748b', maxWidth: '200px' }}>Our system will verify the certificate in our secure database.</p>
                </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flex: 1 }}>
                  ...
                  <h3 style={{ fontSize: '0.95rem', fontWeight: 600, color: '#0f172a', marginBottom: '0.5rem' }}>Step 3</h3>
                  <p style={{ fontSize: '0.85rem', color: '#64748b', maxWidth: '200px' }}>Instantly view your verification result and certificate details.</p>
                </div>
              </div>
            </div>
          </>
