...
const API_UPLOADS = path.join(__dirname, 'public', 'uploads');
const WEB_UPLOADS = path.join(__dirname, '..', 'web', 'public', 'uploads');
...
async function main() {
  ...
  // Now update database records for Training
  ...
  for (const t of trainings) {
    ...
    if (!assignedUrl) {
      // Default to road-safety if no match
  ...
  console.log('Successfully copied images and updated Training modules in database!');
}
